...
public class ImpostoController implements Initializable {
    ...
    private void showValorAPagar() {
        ...
        if (idade.getText().isEmpty() || numeroDependentes.getText().isEmpty()) {
            pessoaFisica = new PessoaFisica(nome.getText(), CPF.getText(), new BigDecimal(contribuicaoOficial.getText()), new BigDecimal(rendimentoTotal.getText()));
        } else {
            pessoaFisica = new PessoaFisica(nome.getText(), CPF.getText(), Integer.parseInt(idade.getText()), Integer.valueOf(numeroDependentes.getText()), new BigDecimal(contribuicaoOficial.getText()), new BigDecimal(rendimentoTotal.getText()));
        }
